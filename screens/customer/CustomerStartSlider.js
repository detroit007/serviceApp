...
import { StyleSheet, Text, View, Dimensions, StatusBar, Image, ScrollView, TouchableWithoutFeedback } from 'react-native';
...
const CustomerStartSlider = ({navigation}) => {
    ...
    return (
      ...
      <View style={styles.container}>
            ...
            <View style={{alignItems: 'center'}}>
              <CacheImage source={require('../../assets/img/slider/postProposal.png')} style={styles.imageStyle}/>
            ...
            <ButtonBox 
                ...
                text="GET STARTED"
                onPress={()=> {navigation.navigate('CustomerDraw')}}
            />
      </View>
...
export default CustomerStartSlider;