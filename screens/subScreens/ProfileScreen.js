          ...
          <ScrollView>
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={()=>{navigation.navigate('ReviewScreen')}} >
                ...
                <View style={styles.bottomWraper}>
                    ...
                    <View>
                        <Text style={styles.label}>78</Text>
                        <Text style={styles.label}>Providers Hired</Text>
                    </View>
                </View>
                </TouchableOpacity>
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={()=>{navigation.navigate('ServiceHistory')}} >
                ...
                <TouchableOpacity activeOpacity={0.9} onPress={()=>{navigation.navigate('OngoingService')}} >
                <View style={styles.bottomWraper}>
            ...
            <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 1}}>
              <TouchableOpacity activeOpacity={0.9} onPress={()=>{navigation.navigate('ProviderDraw')}} >
                <View style={styles.bottomWraper2}>
                    <Icon name="redo" size={20} color={Colors.accent} style={{margin: 4}}/>
                    <View>
                        <Text style={styles.label}>Switch to Providers</Text>
                    </View>
                </View>
              </TouchableOpacity>
            </View>
